  ...
  return (
    <section className="hero" aria-labelledby="hero-heading">
      ...
      <div className="hero__content">
        ...
        <p className="hero__subtitle">Digital Health Works is a medical device commercialization and sales agency. We help medtech, digital health, and life science companies build revenue across the US and Europe — through health economics strategy, market development, and distributor sales.</p>
