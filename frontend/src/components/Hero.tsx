  ...
  return (
    <section className="hero">
      ...
      <div className="hero__content">
        <h1 className="hero__title">We connect medical innovations to the people who need them most.</h1>
        <p className="hero__subtitle">Medical device commercialization and sales execution for medtech and digital health companies entering the US and European markets.</p>
