      ...
      <div className="container">
        <div className="approach__grid">
          ...
          <div className="approach__body fade-in">
            ...
            <p>Most medical technologies are built forward: designed, validated, approved, then handed to sales with the assumption that revenue will magically follow. <strong>It rarely does.</strong></p>
